...
* **Task 3: K-Nearest Neighbors (KNN)**
  ...
  * **Objective:** Built a classification model and experimented with different values of K to find the optimal decision boundary.

### Level 2: Intermediate
* **Task 1: Logistic Regression**
  * **Dataset:** Customer Churn Dataset
  * **Objective:** Built a binary classifier to predict customer churn, evaluated using ROC curves and precision-recall metrics.
* **Task 2: Decision Trees**
  * **Dataset:** Iris Dataset
  * **Objective:** Implemented a pruned decision tree to prevent overfitting and visualized the tree structure.

### Level 3: Advanced
* **Task 1: Random Forest Classifier**
  * **Dataset:** Customer Churn Dataset
  * **Objective:** Tuned hyperparameters using GridSearchCV and extracted feature importances to understand drivers of churn.
